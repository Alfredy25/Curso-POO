...
from feuh.poo.car.car_type import CarType
from feuh.poo.car.engine import Engine, EngineType
from feuh.poo.car.fuel_tank import FuelTank
from feuh.poo.car.person import Person
from feuh.poo.car.wheel import Wheel
...
subaru_legacy = Car.with_cylinder('Subaru','Legacy', Color.RED, Engine(1.8, EngineType.DIESEL))
subaru_legacy.car_type = CarType.STATION_WAGON
subaru_legacy.driver = Person('Andres', 'Guzman')
for i in range(5):
    subaru_legacy.add_wheel(Wheel('Pierelli', 18, 10))
# print(subaru_legacy)

mazda_bt50 = Car.full_spec('Mazda', 'BT-50', Color.RED, Engine(1.8, EngineType.DIESEL), FuelTank(50))
mazda_bt50.car_type = CarType.PICKUP
mazda_bt50.driver = Person('Bea', 'Doe')
for i in range(5):
    mazda_bt50.add_wheel(Wheel('Pierelli', 21, 12))
# print(mazda_bt50)
...
for i in range(5):
    subaru_legacy.add_wheel(Wheel('Yokohama', 18, 10))
# print(subaru_impreza)
