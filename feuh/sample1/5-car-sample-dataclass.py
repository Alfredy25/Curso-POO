...
car3 = Car.with_cylinder('Subaru','Legacy', Constants.COLOR_RED, Engine(1.8, EngineType.GASOLINE))
print(car3)

car4 = Car.full_spec('Mazda', 'BT-50', Constants.COLOR_RED, Engine(3.0, EngineType.DIESEL), FuelTank(50))
print(car4)
...
Constants.MAX_SPEED_HIGHWAY = 200
print(Constants.MAX_SPEED_HIGHWAY)
