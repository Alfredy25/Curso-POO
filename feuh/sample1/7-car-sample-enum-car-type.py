...
from feuh.poo.car.engine import EngineType, Engine
...
car4 = Car.full_spec('Mazda', 'BT-50', Color.RED, Engine(3.0, EngineType.DIESEL), FuelTank(50))
...
print()
print(car1.car_type)
print(car2.car_type.name)
print(car2.car_type.name_default)
print(car2.car_type.description)
print(car2.car_type.door_count)
