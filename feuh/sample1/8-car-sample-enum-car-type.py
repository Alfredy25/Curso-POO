...
car3 = Car.with_cylinder('Subaru','Legacy', Color.RED, Engine(1.8, EngineType.DIESEL))
car3.car_type = CarType.STATION_WAGON
print(car3)

car4 = Car.full_spec('Mazda', 'BT-50', Color.RED, Engine(1.8, EngineType.DIESEL), FuelTank(50))
